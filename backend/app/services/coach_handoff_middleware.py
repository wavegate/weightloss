...
_COACH_TOOLS = [*COACH_TOOLS, transfer_to_metabolism_coach]
_METABOLISM_TOOLS = [*METABOLISM_TOOLS, transfer_to_weight_loss_coach]
...
async def apply_active_agent_config(
    ...
    if _active_agent(request) == METABOLISM_AGENT_NAME:
